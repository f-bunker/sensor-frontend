...
export async function getData(id:String) {
  ...
  if (sensorData === null) return [["Zeitraum eines Monat", "Luft"],[]]
  return [
    ["", "Luft"],
    ...sensorData.slice(0, 24).reverse().map(sensor => [sensor.timestamp.slice(5, 10), sensor.hum_median])
  ]
}

export const options = {
  title: "Age vs. Weight comparison",
  hAxis: { title: "Luft", minValue: 0, maxValue: 15 },
  vAxis: { title: "Zeit", minValue: 0, maxValue: 15 },
  legend: "none",
};

const ChartWraperMonthHum = ({ chartClass }: { chartClass: string }): JSX.Element => {
...
export default ChartWraperMonthHum;